...
if __name__ == '__main__':
    ...
    parser.add_argument('--train_path', type=str,
                        default='/content/drive/MyDrive/HarDNet-MSEG/Kvasir_SEG_Training_880', help='path to train dataset')
    
    parser.add_argument('--test_path', type=str,
                        default='/content/drive/MyDrive/HarDNet-MSEG/Kvasir_SEG_Validation_120' , help='path to testing Kvasir dataset')
